//
//  HarringtonWillComposableViewDescription.swift
...
struct HarringtonWillComposableViewDescription: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            ...
            List {
                NavigationLink(destination: HarringtonWillComposableView()) {
...
struct HarringtonWillComposableViewDescription_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            HarringtonWillComposableViewDescription()
        }
    }
}
